...
spa.shell = ( function () {
    ...
    var
        ...
        initModule = function ( $container ) {
            // HTMLをロードして、jqueryコレクションをマッピングする
            ...
            $.uriAnchor.configModule({
                schema_map : configMap.anchor_chema_map
            });
